...
app.post('/generate-otp',profileController.GenerateOTP)
app.post('/verify-otp',profileController.VerifyOTP)
app.post('/register-profile',profileController.RegisterProfile)
